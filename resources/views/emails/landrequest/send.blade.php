                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Tolong berikan persetujuan untuk Permintaan Pembayaran dengan nomor dokumen {{ $data['doc_no'] }}, dengan rincian: {{ $data['type'] }} , sejumlah Rp.{{ $data['request_amt'] }}.</p>
