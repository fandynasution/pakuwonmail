                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #000000; font-size: 14px;">Please Approve Temporary Merge Lot number {{ $data['temp_no'] }}, Prospect No {{ $data['prospect_no'] }}, unit no {{ $data['lot_no'] }}. Area : {{ $data['land_area'] }} M&sup2; with Entity : {{ $data['entity_name'] }}.</p>
