                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Tolong berikan persetujuan untuk Gambar Ukur yang terbentuk pada ArcGIS dan sudah terupload di IFCA, dengan nomor dokumen {{ $data['doc_no'] }},NOP: {{ $data['nop_no'] }}, Nama Pemilik: {{ $data['name_owner'] }}, dengan luas tanah yang disepakati sebesar {{ $data['land_area_spk'] }}m&sup2;.</p>
