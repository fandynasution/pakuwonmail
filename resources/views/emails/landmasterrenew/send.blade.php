                        ...
                        <tbody>
                            <tr>
                                ...
                                <h5 style="margin-bottom: 24px; color: #526484; font-size: 20px; font-weight: 400; line-height: 28px;">Untuk Bapak/Ibu {{ $data['user_name'] }}</h5>
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Tolong berikan persetujuan untuk Perpanjangan Izin Lokasi Lahan {{ $data['entity_name'] }} dengan nomor dokumen {{ $data['doc_no'] }},dan Nomor Perpanjangan Izin Lokasi {{ $data['land_no'] }} dengan luas {{ $data['area'] }}m&sup2; ,yang berlokasi di {{ $data['city'] }}.</p>
