                        ...
                        <tbody>
                            <tr>
                                ...
                                <p>Please Give a Remarks to <?php echo $doc_no?> <?php echo $name?> : </p>
                                    <form id="frmEditor" class="form-horizontal" method="POST" action="{{url('/api/landapprovalhandovershgb/update')}}" enctype="multipart/form-data">
                                    @csrf
