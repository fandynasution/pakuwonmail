                        ...
                        <tbody>
                            <tr>
                                ...
                                <p>Please Give a Remarks to <?php echo $doc_no?> <?php echo $name?> : </p>
                                    <form id="frmEditor" class="form-horizontal" method="POST" action="{{url('/api/saleslot/update')}}" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <input type="text" id="rt_grp_name" name="rt_grp_name" value="<?php echo $rt_grp_name?>" hidden>
