                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Please Approve Temporary Merge no. {{ $data['temp_no'] }}, Prospect No {{ $data['prospect_no'] }}, old unit {{ $data['lot_no_hd'] }}, area : {{ $data['rentable_area'] }} M&sup2; merge to new unit {{ $data['lot_no'] }}, area : {{ $data['land_area'] }} M&sup2; with Entity : {{ $data['entity_name'] }}.</p>
