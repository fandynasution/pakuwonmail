                        ...
                        <tbody>
                            <tr>
                                ...
                                <h5 style="margin-bottom: 24px; color: #526484; font-size: 20px; font-weight: 400; line-height: 28px;">Dear Mr./Mrs. {{ $data['user_name'] }},</h5>
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 14px;">Please Approve {{ $data['descs'] }} with Prospect No : {{ $data['prospect_no'] }} and Lot No : {{ $data['lot_no'] }} in Entity {{ $data['entity_name'] }}.</p>
