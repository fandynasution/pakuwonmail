                        ...
                        <tbody>
                            <tr>
                                ...
                                <p>Please Give a Remarks to <?php echo $doc_no?> <?php echo $name?> : </p>
                                    <form id="frmEditor" class="form-horizontal" method="POST" action="{{url('/api/saleslotactivityprosp/update')}}" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <input type="text" id="prospect_no" name="prospect_no" value="<?php echo $prospect_no?>" hidden>
