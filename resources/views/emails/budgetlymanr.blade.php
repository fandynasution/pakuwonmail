                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    <h5 style="margin-bottom: 24px; color: #526484; font-size: 20px; font-weight: 400; line-height: 28px;">Dear Mr. {{ $data['user_name'] }}</h5>
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Please Approve for {{ $data['body'] }} {{ $data['entity_name'] }} Project {{ $data['project_name'] }} Amount {{ $data['amount'] }}</p>
