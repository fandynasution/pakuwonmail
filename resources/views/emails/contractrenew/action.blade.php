                        ...
                        <tbody>
                            <tr>
                                ...
                                <p>Please Give a Remarks to <?php echo $doc_no?> <?php echo $name?> : </p>
                                    <form id="frmEditor" class="form-horizontal" method="POST" action="{{url('/api/contractrenew/update')}}" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <input type="text" id="grp_name" name="grp_name" value="<?php echo $grp_name?>" hidden>
