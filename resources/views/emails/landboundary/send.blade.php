                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Tolong berikan persetujuan untuk SPK Pematokan bidang tanah dengan nomor dokumen {{ $data['doc_no'] }}, dan nomor SPK: {{ $data['boundary_ref'] }} yang pengerjaannya dilakukan oleh Bapak/Ibu {{ $data['off_name'] }}. </p>
