                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 0px 30px 0px 20px">
                                    ...
                                    <p style="text-align:left;color: #000000; font-size: 14px;">Tolong berikan persetujuan untuk SPK Pematokan bidang tanah dengan detail :</p>
                                    <table cellpadding="0" cellspacing="0" style="text-align:left;width:100%;max-width:800px;margin:0 auto;font-size: 14px;background-color:#ffffff; color: #000000;">
                                        ...
                                        <tr>
                                            <td>Nomor SPK Pematokan</td>
                                            <td> : </td>
                                            <td> {{ $data['boundary_ref'] }} </td>
                                        </tr>
                                        <tr>
                                            <td>Petugas Pematokan</td>
                                            <td>:</td>
                                            <td>{{ $data['off_name'] }}</td>
                                        </tr>
                                        <tr>
