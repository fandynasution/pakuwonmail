            ...
            <tbody>
                <tr>
                    <td style="text-align:center;padding: 0px 30px 0px 20px">
                        ...
                        <p style="text-align:left;color: #000000; font-size: 14px;">Tolong berikan persetujuan untuk proses Pemecahan SHGB {{ $data['shgb_no_split'] }} dengan detail :</p>
                        <table class="remove" cellpadding="0" cellspacing="0" style="text-align:left;width:100%;max-width:1200px;;background-color:#ffffff;">
                            <tr>
                                ...
                                <th style="border: 1px solid #000; text-align: center;">No. SHGB BPN</th>
                                <th style="border: 1px solid #000; text-align: center;">No. SPPT</th>
                                <th style="border: 1px solid #000; text-align: center;">No. NIB</th>
                            ...
                            <tr>
                                <td style="border: 1px solid #000;padding: 5px;">{{ $data['shgb_no_split'] }} </td>
                                <td style="border: 1px solid #000;padding: 5px;"> {{ $data['shgb_no_bpn_split'] }} </td>
                                <td style="border: 1px solid #000;padding: 5px;"> {{ $data['nop_no_split'] }} </td>
                                <td style="border: 1px solid #000;padding: 5px;">{{ $data['nib_no_split'] }} </td>
                                <td style="border: 1px solid #000;padding: 5px;">{{ $data['shgb_date_split'] }} </td>
                                <td style="border: 1px solid #000;padding: 5px;">{{ $data['shgb_expired_split'] }} </td>
                            ...
                            <!-- Find and display the first merge -->
                                @if(isset($data['shgb_no'][0]))
                                    <tr>
                                        ...
                                        <td style="border: 1px solid #000;padding: 5px;"> {{ $data['shgb_no_bpn'][0] }} </td>
                                ...
                                @for($i = 1; $i < count($data['shgb_no']); $i++)
                                    @if(isset($data['shgb_no'][$i], $data['shgb_no_bpn'][$i], $data['nop_no'][$i], $data['nib_no'][$i], $data['shgb_date'][$i], $data['shgb_expired'][$i], $data['shgb_area'][$i]))
                                        <tr>
                                            <td style="border: 1px solid #000;padding: 5px;">{{ $data['shgb_no'][$i] }} </td>
                                            <td style="border: 1px solid #000;padding: 5px;"> {{ $data['shgb_no_bpn'][$i] }} </td>
