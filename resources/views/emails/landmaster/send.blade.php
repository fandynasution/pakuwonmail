                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Tolong berikan persetujuan untuk Izin Lokasi Lahan {{ $data['entity_name'] }} dengan nomor dokumen {{ $data['doc_no'] }},dan Nomor Izin Lokasi {{ $data['land_no'] }} dengan luas {{ $data['area'] }}m&sup2; ,yang berlokasi di {{ $data['city'] }}.</p>
