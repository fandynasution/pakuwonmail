                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #000000; font-size: 14px;">Please Approve Revenue Sharing, {{ $data['debtor_name'] }}, {{ $data['pgs_doc_no'] }}.</p>
                                    <p style="margin-bottom: 15px; color: #000000; font-size: 14px;">with Total Sales = {{ $data['total_sales'] }}, Tarif percent = {{ $data['tariff_percent'] }}, Base Amount = {{ $data['tariff_amt'] }}, Tax Amount = {{ $data['tax_amt'] }}, Total = {{ $data['net_amt'] }}.</p>
