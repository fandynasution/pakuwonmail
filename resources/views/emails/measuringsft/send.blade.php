                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Tolong berikan persetujuan untuk Proses Penukuran Tanah yang telah dilakukan oleh BPN, dengan nomor dokumen {{ $data['doc_no'] }}, Kloter: {{ $data['kloter'] }}, No. Berkas: {{ $data['file_no'] }} dan NIB: {{ $data['nib_no'] }} dengan Biaya PNBP Pengukuran sebesar Rp.{{ $data['measuring_amt'] }}</p>
