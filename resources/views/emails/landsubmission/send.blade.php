            ...
            <tbody>
                <tr>
                    <td style="text-align:center;padding: 0px 30px 0px 20px">
                        ...
                        <p style="text-align:left;color: #526484; font-size: 14px;">Tolong berikan persetujuan untuk Pengajuan Pembayaran {{ $data['doc_no'] }} Periode SPH : {{ $data['sph_trx_no'] }} dengan detail :</p>
