                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Please approve No Progress {{ $data['old_doc_no'] }} with the current progress percentage of {{ $data['curr_progress'] }}% with a total progress of IDR {{ $data['amount'] }} from PO No. {{ $data['PONumberOracle']}}.</p>
