                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Tolong berikan persetujuan untuk Permohonan SK HAK yang telah selesai dilakukan, dengan nomor dokumen {{ $data['doc_no'] }}, Nomor Permohonan SK: {{ $data['ref_no'] }}, No. SK: {{ $data['sk_no'] }} dengan Biaya PNBP SK HAK sebesar Rp.{{ $data['sk_amt'] }}.</p>
