                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Tolong berikan persetujuan untuk Proses SHGB yang telah dilakukan, dengan nomor dokumen {{ $data['doc_no'] }}, No. SHGB: {{ $data['ref_no'] }}, NOP Perusahaan: {{ $data['nop_no'] }}, Luas PBT {{ $data['pbt_area'] }}m&sup2;. Dengan Biaya SK SHGB sebesar Rp.{{ $data['shgb_amt'] }}.</p>
