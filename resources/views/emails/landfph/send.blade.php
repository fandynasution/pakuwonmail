                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Tolong berikan persetujuan untuk Form Penawaran Harga dengan nomor dokumen {{ $data['doc_no'] }}, NOP: {{ $data['nop_no'] }}, Nama Pemilik: {{ $data['name_owner'] }} dengan nominal yang disepakati adalah Rp.{{ $data['total_amt'] }}, dan Uang Tanda Jadi yang diberikan kepada pemilik sebesar Rp.{{ $data['book_amt'] }}</p>
                                    ...
                                    <p style="text-align:left;margin-bottom: 15px; color: #000000; font-size: 16px">
                                        ...
                                        @foreach($data['url_link'] as $tampil)
                                            <a href={{ $tampil }} target="_blank">{{ trim(str_replace('%20',' ',substr($tampil, strrpos($tampil, '/') + 1))) }}</a><br>
                                        @endforeach
                                    </p>
                                </td>
                            </tr>
