                        ...
                        <tbody>
                            <tr>
                                ...
                                <p>Please Give a Remarks to <?php echo $doc_no?> <?php echo $name?> : </p>
                                    <form id="frmEditor" class="form-horizontal" method="POST" action="{{url('/api/approvestatusLandChangeNop/update')}}" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <input type="text" id="entity_name" name="entity_name" value="<?php echo $entityName?>" hidden>
